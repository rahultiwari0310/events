...
export const checkTimeOverlaps = (
  ...
  return eventAStartTime.isBetween(eventBStartTime, eventBEndTime) || eventAEndTime.isBetween(eventBStartTime, eventBEndTime) || eventBStartTime.isBetween(eventAStartTime, eventAEndTime) || eventBEndTime.isBetween(eventAStartTime, eventAEndTime);
};
